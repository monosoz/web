<div class="clearfix">
	...
	<div class="add-map col-xs-6 col-sm-4">
		<img class="img-responsive pull-right" src={{"https://maps.googleapis.com/maps/api/staticmap?key=" . config('app.map_key') . "&center=28.5383277,77.1980605&zoom=11&size=200x200&maptype=roadmap&markers=color:red|" . $location->lat . "," . $location->lng}}>
	</div>
